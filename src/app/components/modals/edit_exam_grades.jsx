  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showAlert("success", "Exam result updated successfully");
        ...
        showAlert("error", "Error updating exam result");
      }
    } catch (error) {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (res.ok) {
        ...
        showAlert("success", "Exam result deleted successfully");
        onGradeUpdated(); // Call the callback function to refetch grades
        setOpen(false);
      } else {
        const errorData = await res.json();
        console.error("Error deleting exam result:", errorData.error);
        showAlert("error", "Error deleting exam result");
      }
    } catch (error) {
      console.error("Request failed:", error);
      showAlert("error", "Request failed");
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                    ...
                    <div className="flex items-end justify-end">
                      <button
                        type="button"
                        className="inline-flex w-full justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:mt-0 sm:w-auto sm:text-sm ml-3"
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete this exam result? This
